...
protected static final main plugin = main.p;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            sender.sendMessage("Du hast " + PlayerManager.getDiggingXP(((Player) sender).getUniqueId().toString()) + " XP in Level " + PlayerManager.getDiggingLvl(((Player) sender).getUniqueId().toString()));
